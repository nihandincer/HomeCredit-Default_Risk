...
def application_train_test(num_rows=None, nan_as_category=False):
    ...
    # toplam kredi tutarı / ürün fiyatı
    ...
    # Kredi miktarının ürün miktarına göre farkı
    ...
    # Dış kaynaktan alınan puanların ağırlıklı çarpımı
    ...
    # FEATURE 4 - GELİR / AİLEDEKİ KİŞİ SAYISI
    ...
    # FEATURE 21 - NEW_FRAUD : ADRES UYUMSUZLUKLARI
